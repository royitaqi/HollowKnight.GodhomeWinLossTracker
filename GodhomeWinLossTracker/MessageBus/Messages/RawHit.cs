...
namespace GodhomeWinLossTracker.MessageBus.Messages
{
    ...
    {
        public RawHit(string timestamp, string sequenceName, string bossName, string sceneName, int tkStatus, int tkPosX, int tkPosY, int tkHealthBefore, int damageAmount, DamageSources damageSource, float bossHP, string bossState, int bossPosX, int bossPosY, long fightLengthMs, RecordSources recordSource, int bossPhase)
        {
        ...
        public override string ToString()
        {
            ...
            string msg = $"TK hit by {BossName} in {SequenceName} at {TKHealthBefore} masks and {(int)(BossHP * 100)}% boss HP with boss attack {BossState}";
            if (BossPhase != 0)
            {
        ...
        public DamageSources DamageSource { get; private set; }
