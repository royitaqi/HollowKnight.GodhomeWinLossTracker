...
namespace UnitTests
{
    ...
    public class TestWinLossGenerator
    {
        ...
        private readonly RawWinLoss Win = new RawWinLoss("", SequenceName, BossName, BossSceneName, 1, 0, 0, 0, 0, 0, 0, 0, RawWinLoss.Sources.Mod);
        private readonly RawWinLoss Loss = new RawWinLoss("", SequenceName, BossName, BossSceneName, 0, 1, 0, 0, 0, 0, 0, 0, RawWinLoss.Sources.Mod);
