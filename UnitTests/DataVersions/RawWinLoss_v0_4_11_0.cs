...
namespace UnitTests
{
    public class RawWinLoss_v0_4_11_0 : IMessage
    {
        public RawWinLoss_v0_4_11_0(string timestamp, string sequenceName, string bossName, string sceneName, int wins, int losses, int heals, int healAmount, int hits, int hitAmount, float bossHP, long fightLengthMs, RecordSources_v0_4_11_0 recordSource)
        {
