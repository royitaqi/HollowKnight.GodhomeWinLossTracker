...
namespace UnitTests
{
    public class RawWinLoss_v0_2_1_0 : IMessage
    {
        public RawWinLoss_v0_2_1_0(string timestamp, string sequenceName, string bossName, string sceneName, int wins, int losses, long fightLengthMs, Sources_v0_2_1_0 source)
        {
        ...
        {
            DevUtils.Assert(Source == Sources_v0_2_1_0.Mod, "Only records generated by mod can be displayed");
        ...
        public Sources_v0_2_1_0 Source { get; private set; }
    }
}
