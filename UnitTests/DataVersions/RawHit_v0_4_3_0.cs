...
namespace UnitTests
{
    public class RawHit_v0_4_3_0 : IMessage
    {
        public RawHit_v0_4_3_0(string timestamp, string sequenceName, string bossName, string sceneName, int tkStatus, int tkHealthBefore, int damageAmount, DamageSources_v0_4_3_0 damageSource, float bossHP, string bossState, long fightLengthMs, RecordSources_v0_4_3_0 recordSource)
        {
        ...
        public DamageSources_v0_4_3_0 DamageSource { get; private set; }
