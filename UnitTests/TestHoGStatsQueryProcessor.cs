namespace UnitTests
{
    ...
    public class TestHoGStatsQueryProcessor
    {
        ...
        {
            new RawWinLoss("", SequenceName, BossA, BossAAscendedScene, 10, 5, 0, 0, 0, 0, 0, 0, G.RecordSources.Test, 0),
            // Irellevant sequence
            new RawWinLoss("", IrrelevantSequenceName, BossA, BossAAscendedScene, 10, 5, 0, 0, 0, 0, 0, 0, G.RecordSources.Test, 0),
            // Reverted order of scenes
            new RawWinLoss("", SequenceName, BossA, BossAAttunedScene, 10, 5, 0, 0, 0, 0, 0, 0, G.RecordSources.Test, 0),
            new RawWinLoss("", IrrelevantSequenceName, BossA, BossAAttunedScene, 10, 5, 0, 0, 0, 0, 0, 0, G.RecordSources.Test, 0),
            // Irrelevant boss
            new RawWinLoss("", SequenceName, BossB, BossBScene, 1000, 2000, 0, 0, 0, 0, 0, 0, G.RecordSources.Test, 0),
            // More stats
            new RawWinLoss("", SequenceName, BossA, BossAAttunedScene, 4, 1, 0, 0, 0, 0, 0, 0, G.RecordSources.Test, 0),
            new RawWinLoss("", IrrelevantSequenceName, BossA, BossAAttunedScene, 4, 1, 0, 0, 0, 0, 0, 0, G.RecordSources.Test, 0),
            new RawWinLoss("", SequenceName, BossA, BossAAscendedScene, 20, 45, 0, 0, 0, 0, 0, 0, G.RecordSources.Test, 0),
            new RawWinLoss("", IrrelevantSequenceName, BossA, BossAAscendedScene, 20, 45, 0, 0, 0, 0, 0, 0, G.RecordSources.Test, 0),
        };
        ...
        {
            new RawWinLoss("", SequenceName, BossB, BossBScene, 10, 5, 0, 0, 0, 0, 0, 0, G.RecordSources.Test, 0),
            // Irrelevant boss
            new RawWinLoss("", SequenceName, BossA, BossAAscendedScene, 1000, 2000, 0, 0, 0, 0, 0, 0, G.RecordSources.Test, 0),
            // More stats
            new RawWinLoss("", SequenceName, BossB, BossBScene, 20, 45, 0, 0, 0, 0, 0, 0, G.RecordSources.Test, 0),
        };
        ...
        {
            // Irrelevant boss
            new RawWinLoss("", SequenceName, BossA, BossAAttunedScene, 1000, 2000, 0, 0, 0, 0, 0, 0, G.RecordSources.Test, 0),
            // Irellevant sequence
            new RawWinLoss("", IrrelevantSequenceName, BossB, BossBScene, 10, 5, 0, 0, 0, 0, 0, 0, G.RecordSources.Test, 0),
        };
